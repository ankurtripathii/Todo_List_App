...
import com.anksys.todolistapp.digitalbrain.Main.MainActivity;
import com.anksys.todolistapp.digitalbrain.Main.MainFragment;
...
public class ReminderFragment extends AppDefaultFragment {
    ...
    public static final String EXIT = "com.anksys.todolistapp.digitalbrain.exit";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.toDoReminderDoneMenuItem:
                ...
                Log.d("anksys", "Date Changed to: " + date);
                changeOccurred();
                saveData();
                closeApp();
                //foo
